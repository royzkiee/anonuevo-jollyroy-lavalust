...
<div class="page-wrap">
    <div class="header-card">
        <div class="header-badge">Inventory Management · Record #<?= html_escape($product['id']); ?></div>
        <h1>Edit Motorcycle Part</h1>
        <p>Update inventory details and specifications for <strong><?= html_escape($product['product_name']); ?></strong>.</p>
    </div>
